...
import { PageHeader04, Project06 } from "gatsby-theme-container";
...
const PortfolioGrid3Column = () => (
    <Layout theme={theme}>
        ...
        <Project06 data={allContent.project_section} />
        <Footer01 data={{ ...footerData, ...contactData }} />
    </Layout>
);

export default PortfolioGrid3Column;
